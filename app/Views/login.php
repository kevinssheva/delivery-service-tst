...
<section class="bg-light">
  <div class="container-fluid">
    <div class="row justify-content-center align-items-center min-vh-100">
      <div class="col-md-6">
        <a href="#" class="d-flex align-items-center mb-4 text-dark text-decoration-none bg-dark p-3 rounded">
          <span class="fs-4 fw-semibold text-white">Delivery Service</span>
        </a>
